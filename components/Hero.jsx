...
export default function HeroSection() {
  ...
  return (
    <section className="overflow-hidden">
      <div className="hero-wrapper flex flex-col justify-between min-h-screen">
        <Header />
        <div className="hero-container bg-[#ffffff] text-black px-4 md:px-8 pb-8">
          <div className="md:text-center mt-8 md:mt-8">
            <div className="flex flex-col md:flex-row md:justify-center md:items-end gap-0 md:gap-8 mb-4 md:mb-12">
              ...
              <div className="overflow-hidden">
                <h1 className="text-creative text-[4.5rem] md:text-[9rem] font-normal font-turtosk pt-0 md:pt-0 pb-2 md:pb-6 uppercase leading-none tracking-tight">
                  CREATIVE
                </h1>
              </div>
          ...
          <div className="flex md:h-[50vh] flex-col md:flex-row justify-between items-start md:items-start gap-6 md:gap-16">
            {/* LEFT COLUMN */}
            <div className="w-full md:w-1/3 min-h-full space-y-1 md:space-y-4">
              <div className="overflow-hidden">
              ...
              <div className="overflow-hidden">
                <p className="animate-up text-gray-800 max-w-2xs md:max-w-md mb-2 md:mb-4 text-base sm:text-3xl font-satoshi leading-[1.1] md:leading-none">
            ...
            <div className="flex md:hidden w-full h-full justify-end items-end">
              ...
              <div className="w-1/2 h-full flex justify-center overflow-hidden">
                <div className="animate-up w-48 h-48 relative overflow-hidden">
                  <Image
                    src="/images/hero.jpg"
                    alt="Huy Nguyen"
                    fill
