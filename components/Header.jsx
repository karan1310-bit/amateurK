  ...
  return (
    <nav className="flex md:items-center gap-4 bg-[#ffffff] px-4 md:px-8 justify-between py-4 md:py-5 font-satoshi w-full">
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-0 md:gap-2">
        <p className="nav-word text-xl md:text-3xl font-bold">
          K<sup className="text-lg align-top">©</sup>
        </p>
        <p className="nav-word text-gray-500 text-base md:text-xl">
      ...
      <ul className="md:flex md:gap-2">
        {navLinks.map((link, index) => (
          <li key={index} className="leading-none text-lg md:text-2xl uppercase text-gray-500">
